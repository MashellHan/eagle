...
Install `@nocoo/eagle-agent@0.6.0` with Node 24+ and Herdr. Reuse the machine’s existing management Agent for semantics; Hermes Agent is recommended, not required:
