/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: d446f77a6c5f8a1733b1129e97742f4e)
// Runtime types generated with workerd@1.20260918.1 2026-09-19 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	ASSETS: Fetcher;
	BUILD_REVISION: "development";
	ACCESS_TEAM_URL: "https://nocoo.cloudflareaccess.com";
	ACCESS_AUD: "d1ffdb7fe2787e2a9e8f957a68ed5feec2b944c44c6fdbfd54341887eab6f873";
	AGENT_TOKENS: string;
	LOCAL_DEV: string;
	LOCAL_USER_EMAIL: string;
	AGENT_SIGNING_KEY: string;
	MACHINES: DurableObjectNamespace<import("./src/worker/index").MachineState>;
	DIRECTORY: DurableObjectNamespace<import("./src/worker/index").MachineDirectory>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/index");
		durableNamespaces: "MachineState" | "MachineDirectory";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUILD_REVISION" | "ACCESS_TEAM_URL" | "ACCESS_AUD" | "AGENT_TOKENS" | "LOCAL_DEV" | "LOCAL_USER_EMAIL" | "AGENT_SIGNING_KEY">> {}
}
